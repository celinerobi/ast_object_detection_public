...
#SBATCH --output /hpc/home/csr33/ast_object_detection/train_imgsz_512.out
#SBATCH --error /hpc/home/csr33/ast_object_detection/train_imgsz_512.err
...
yolo detect val data="/hpc/home/csr33/ast_object_detection/ast.yaml" model="/work/csr33/object_detection/runs/detect/baseline_train/weights/best.pt"