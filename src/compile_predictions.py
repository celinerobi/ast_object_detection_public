...
def get_args_parse():
    ...
    #parser.add_argument("--compiled_data_path", default=str, type=int)
...
def compile_data(args):
    ...
    detected_tanks_gdf.to_file("/hpc/group/borsuklab/csr33/object_detection/compiled_predicted_tank.geojson", driver='GeoJSON') 
