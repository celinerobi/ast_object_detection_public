...
commpile_data_path-"/hpc/group/borsuklab/csr33/object_detection/compiled_predicted_tank.geojson"
python /hpc/home/csr33/ast_object_detection/src/compile_predictions.py --detect_tank_dir "/hpc/group/borsuklab/csr33/object_detection/height_estimation.geojson"
...
sbatch --job-name $chemical_data_jobname --output $output_dir/$chemical_data_jobname/$chemical_data_jobname"_%a.out" --error $error_dir/$chemical_data_jobname/$chemical_data_jobname"_%a.err" --export=compile_data_path=,tri_with_sg_path=$tri_with_sg_path $chemical_data_script