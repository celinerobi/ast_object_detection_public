...
python /hpc/home/csr33/ast_object_detection/src/redownload.py --tile_dir "/work/csr33/images_for_predictions/naip_tiles" --naip_data_path "/work/csr33/images_for_predictions/naip_tile_in_slosh_modeled_area.parquet" --connections 8