...
python /hpc/home/csr33/ast_object_detection/src/train.py --model "yolov8x.pt" --epochs 300 --workers 5 --name "train_w_tuned_hyperparameters" --imgsz 640 --tune_yaml "/work/csr33/object_detection/runs/detect/tune10/best_hyperparameters.yaml" --data "/hpc/home/csr33/ast_object_detection/ast.yaml"
