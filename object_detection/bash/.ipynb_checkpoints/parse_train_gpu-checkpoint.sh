...
#SBATCH --output=/hpc/home/csr33/ast_object_detection/object_detection/bash/output/parse_model_output.out
#SBATCH --error=/hpc/home/csr33/ast_object_detection/object_detection/bash/error/parse_model.err
...
CUDA_LAUNCH_BLOCKING=1 python /hpc/home/csr33/ast_object_detection/object_detection/model_train.py --parent_directory /hpc/group/borsuklab/faster-rcnn --path_to_predefined_classes /hpc/home/csr33/ast_object_detection/object_detection/predefined_classes.txt --num_workers 1 --val_size 0.2 --scheduler_name exponentiallr --lr 0.010 --lr_gamma 0.9 --scheduler_name exponentiallr --batch_size 2 --num_workers 1 --num_epochs 50
